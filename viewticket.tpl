...
<h2 class="ticket-subject">
    ...
    <a href="supporttickets.php#" onclick="$('#ticketstatus').val('Closed');$('#ticketstatus').trigger('change');return false" class="close-ticket btn btn-default btns-padded"><i class="far fa-times-circle"></i> {$_ADMINLANG.global.close}</a>
</h2>
