...
jQuery(document).ready(function() {
    ...
    jQuery('.auto-recalc-checkbox').on('change', function() {
        var element = jQuery(this).data('element');
        jQuery('#' + element).prop('readonly', jQuery(this).prop('checked')).toggleClass('readonly');
    });
...
function slugify(text) {
    var search =  "ãàáäâảẩấđẽèéëêếìíïîõòóöôốớơùúüûưñç·/_,:;–"; // contains Unicode dash
    var replace = "aaaaaaaadeeeeeeiiiioooooooouuuuunc-------";
